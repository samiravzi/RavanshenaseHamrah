...
public class VideoListActivity extends MyActivity implements NavigationView.OnNavigationItemSelectedListener {

    String TAG = "VListActivity";
    MyActivity activity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*if(MainActivity.mainActivity.videos != null) {
            videos.addAll(MainActivity.mainActivity.videos);
        }*/
...
// -------------------------------------------------------------------------------------------------
    ...
    private void setupCategoriesSpinner(){
        if(DataStore.categories == null || DataStore.categories.size() == 0){
            ...
            ArrayAdapter dataAdapter =  new SpinnerAdapter(VideoListActivity.this, R.layout.list_row_spinner, datesTitle);
...
//        ageTitle.setText(DataStore.ages.get(DataStore.ages.size()-1).getText());
    ...
    private void setupRecycler() {
        ...
        mAdapter = new VideosAdapter(activity, videos);
