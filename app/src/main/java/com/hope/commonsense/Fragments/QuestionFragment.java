...
public class QuestionFragment extends TagFragment {
...
// -------------------------------------------------------------------------------------------------
    ...
    private void setupRecycler(){
        mAdapter = new QuestionsAdapter(getActivity(), questions);
...
// -------------------------------------------------------------------------------------------------
    ...
    public void getQuestions(){
        ...
        TagActivity.activity.sendRequest(parameters, TagActivity.QUESTION);
    }
